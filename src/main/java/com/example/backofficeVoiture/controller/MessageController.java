...
public class MessageController {
    ...
    @GetMapping("/{idUser}/{idSender}/{idAnnonce}")
    public ApiResponse getMessage(@PathVariable String idUser, @PathVariable String idSender, @PathVariable String idAnnonce, @RequestHeader("Authorization") String token){
        return messageService.getMessage(idUser, idSender, idAnnonce, token);
    }
